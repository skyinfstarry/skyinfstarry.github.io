class GameOverScene extends Phaser.Scene {
  ...
  create() {
    ...
    if (this.textures.exists('ovrbox')) this.add.image(cx, cy - 100, 'ovrbox').setScale(0.55, 0.8).setScrollFactor(0);
    ...
    this.add.text(cx, cy - 100, `Your Score: ${this.finalScore}`, {
      fontSize: '52px', fill: '#ffffff', fontFamily, stroke: '#000', strokeThickness: 6
    }).setOrigin(0.5).setScrollFactor(0);
