class GameOverScene extends Phaser.Scene {
  ...
  create() {
    ...
    if (this.textures.exists('ovrbox')) this.add.image(cx, cy - 200, 'ovrbox').setScale(0.55, 0.5).setScrollFactor(0);
    // this.finalScore

    this.add.text(cx, cy - 140, "Try Again!", {
      fontSize: '58px', fill: '#ffffff', fontFamily, stroke: '#000', strokeThickness: 6
