class MainMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(cx, (box ? cy - (box.displayHeight * 0.33) : cy - 600) - 50, "How to Play", {
      fontSize: '70px',
      fill: '#ffffff',
      fontFamily,
      align: 'left',
    ...
    this.add.image(cx + 330, (box ? cy - (box.displayHeight * 0.33) : cy) + 270, 'enemy').setScrollFactor(0).setScale(0.6);
