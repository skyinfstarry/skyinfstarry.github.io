class WinScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(0, 0, 'background2').setOrigin(0).setScrollFactor(0);

    if (this.textures.exists('lvlbox')) this.add.image(cx, cy, 'lvlbox').setScale(0.55, 0.5).setScrollFactor(0);
    ...
    next.on('pointerdown', () => this.bgm && this.bgm.stop(),
