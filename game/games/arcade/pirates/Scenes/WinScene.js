class WinScene extends Phaser.Scene {
  ...
  create() {
    ...
    const bg = (cfg.images2 && cfg.images2.background) ? this.add.image(0, 0, 'winbackground').setOrigin(0).setScrollFactor(0) : null;

    if (this.textures.exists('lvlbox')) this.add.image(cx, cy, 'htpbox').setScrollFactor(0).setScale(0.55, 0.5);
    ...
    lvlReplay.on('pointerdown', () => { if (this.bgm) { this.bgm.stop(); this.bgm.destroy(); this.bgm = null; }
