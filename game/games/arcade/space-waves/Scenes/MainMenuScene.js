class MainMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(cx, (box ? cy - (box.displayHeight * 0.33) : cy - 200) - 80, howTo, {
      fontSize: '70px',
      fill: '#ffffff',
      fontFamily,
      align: 'center',
     ...
     this.add.text(cx -300, (box ? cy - (box.displayHeight * 0.33) : cy - 200) + 80, "Hold to fly:", {
      fontSize: '50px',
      fill: '#ffffff',
      fontFamily,
      align: 'center',
      ...
      lineSpacing: 6
       ...
       this.add.text(cx -300, (box ? cy - (box.displayHeight * 0.33) : cy - 200) + 250, "Avoid:", {
      fontSize: '50px',
      fill: '#ffffff',
      fontFamily,
      align: 'center',
    ...
    this.add.image(880,410,'player').setScale(0.6)
    this.add.image(840,570,'enemy').setScale(0.6)
