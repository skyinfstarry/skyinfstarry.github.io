class WinScene extends Phaser.Scene {
  ...
  create() {
    ...
    if (this.textures.exists('lvlbox')) this.add.image(cx, cy, 'lvlbox').setScale(0.55).setScrollFactor(0);

    this.add.text(cx, cy , title, {
      fontSize: '80px', fill: '#ffffff', fontFamily, stroke: '#000', strokeThickness: 6
